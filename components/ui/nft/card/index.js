...
export default function Card({ nft, disabled, Footer, state }) {
  return (
      ...
      <div className="flex flex-row">
        ...
        <div className="p-4 flex-2">
          ...
          <Link href={`/nfts/${nft.slug}`}>
            <a className="block mt-1 text-sm sm:text-base leading-tight font-medium text-black hover:underline">
              {nft.title}
            </a>
          </Link>
