...
export default function OrderModal({ nft, onClose, onSubmit, isNewPurchase }) {
          ...
          <div className="sm:flex sm:items-start">
            <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-1 relative rounded-md">
                <div className="mb-1">
                  <label className="mb-2 font-bold">Price (BAT)</label>
                    ...
                    <label className="flex items-center mr-2">
                      <input
                        ...
                        onChange={({ target: { checked } }) => {
                          setOrder({
                            ...order,
                            price: checked ? order.price : bat.perItem,
                          });
              ...
              <div className="text-xs text-gray-700 flex mt-5">
                ...
                <span>
                  I accept NftMarketplace &apos;terms of service&apos; and I
                  agree that my order can be rejected in the case data provided
